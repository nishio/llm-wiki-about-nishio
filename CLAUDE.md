...
### 第一目的（2026-05-31 ユーザ指示により明示）

**自己紹介ページ (`nhiro.org/ja.html` 等) を更新する** を Wiki 活動の第一目標として置く。詳細方針: [wiki/meta/目的-自己紹介ページ更新.md](wiki/meta/目的-自己紹介ページ更新.md)

このWiki は本人が 2026-05-27 日記で「**放置していた TODO:自己紹介ページを更新する に関しても、そのLLM Wikiが作れば良いのでは**」と構想したものに対応する。ingest が ingest を呼ぶ迷走ループを避け、**Dot 候補と Story の解釈語彙を貯める** という具体成果物に接続する。

新規 ingest や filing-back を行う際は、最後に「これは自己紹介ページ更新の Dot / Story / 解釈語彙にどう寄与するか」を一行でも明示する。
