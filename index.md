---
title: nishio LLM Wiki
---

# nishio LLM Wiki

西尾泰和（nishio）自身についての LLM-Wiki の索引。

一次ソース: Scrapbox `nishio` の Markdown エクスポート（[external_brain_in_markdown](https://github.com/nishio/external_brain_in_markdown), 24,000+ ページ）。
...
- [知的生産](wiki/topics/知的生産.md) — 最大クラスタ。「知識を生み出すこと」を一貫した軸として対象を拡張してきた
- [ブロードリスニング](wiki/topics/ブロードリスニング.md) — 2023年以降の中心関心。「知的生産性向上」フレームで受容
- [Plurality](wiki/topics/Plurality.md) — Audrey Tang・Glen Weyl らの思想・著書。邦訳プロジェクトリーダー
...
- [書く場所による言語化の効果](wiki/concepts/書く場所による言語化の効果.md) — 「**privateだと筆がすすまない**」。public が筆を進める3機構（社会的トリガー / 失われる恐れ / パクリ疑惑からの自由）。ただし日記/内省ログだけは逆向きで private 化する二段構え（2018→2026 の 8 年スパン）
- [果樹園のたとえ](wiki/concepts/果樹園のたとえ.md) — 2026-06-04 提示。Cosense 蓄積 = 果樹園 / AI Agent = ドローン。**ドローンの収穫向上は果樹園の存在に依存**する。後発 ingest でも構造は再現できるが「自分の延長」感は再現できない可能性。[[巨人の肩直通エレベーター]] と対を成し、AI の 2 つの価値（民主化する公共知識 access / しない個人蓄積活性化）を区別
